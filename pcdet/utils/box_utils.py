...
def enlarge_height(boxes3d, extra_1= 0 , extra_2= 0 , extra_width= 0 ):
    """
    Args:
        boxes3d: [x, y, z, dx, dy, dz, heading], (x, y, z) is the box center
        extra_width: [extra_x, extra_y, extra_z]
    ...
    for i in range(large_boxes3d.shape[0]):
        if large_boxes3d[i,0] > 2:
            large_boxes3d[i, 3] +=  extra_1
            large_boxes3d[i, 4] +=  extra_2
            large_boxes3d[i, 5] +=  extra_width
...
def boxes3d_kitti_camera_to_imageboxes(boxes3d, calib, image_shape=None):
    ...
    pts_img, _ = calib.rect_to_img_left(corners3d.reshape(-1, 3))
...
def boxes3d_kitti_camera_to_imageboxes_right(boxes3d, calib, image_shape=None):
    """
    :param boxes3d: (N, 7) [x, y, z, l, h, w, r] in rect camera coords
    :param calib:
    :return:
    ...
    """
    corners3d = boxes3d_to_corners3d_kitti_camera(boxes3d)
    pts_img, _ = calib.rect_to_img_right(corners3d.reshape(-1, 3))
    corners_in_image = pts_img.reshape(-1, 8, 2)
