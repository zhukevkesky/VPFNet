    ...
    for (i = 0; i < boxes_num; i++){
        for (j = 0; j < pts_num; j++){
            ...
            if(cur_in_flag==1){
                ...
                //if  (  abs(reg_target_flat[j*3+2] )> 8 ){
                //    std::cout<<  boxes3d_flat[i*7+2] << "???" <<   boxes3d_flat[i*7+5]  <<  std::endl;   
                //}
