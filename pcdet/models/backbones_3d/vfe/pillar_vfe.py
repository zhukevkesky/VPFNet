...
class PillarVFE(VFETemplate):
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        voxel_features, voxel_num_points, coords = batch_dict[
            'voxels'], batch_dict['voxel_num_points'], batch_dict['voxel_coords']
