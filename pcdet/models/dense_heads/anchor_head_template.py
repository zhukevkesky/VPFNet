...
class AnchorHeadTemplate(nn.Module):
    ...
    def build_losses(self, losses_cfg):
        ...
        self.add_module(
            'reg_no_xy_func',
            getattr(loss_utils, reg_loss_name)(
                code_weights=losses_cfg.LOSS_WEIGHTS['no_xy_weights'])
        )
    ...
    def get_box_reg_layer_loss(self):
        ...
        loc_loss_src = self.reg_loss_func(
            box_preds_sin, reg_targets_sin, weights=reg_weights)  # [N, M]
        loc_loss = loc_loss_src.sum() / batch_size * \
            self.model_cfg.LOSS_CONFIG.LOSS_WEIGHTS['loc_weight']

        tb_dict = {
            'rpn_lidar_loc': loc_loss.item(),
        ...
        if box_dir_cls_preds is not None:
            ...
            tb_dict['rpn_lidar_dir'] = dir_loss.item()
