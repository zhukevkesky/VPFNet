...
class VoxelRCNNHead(RoIHeadTemplate):
    ...
    def roi_grid_pool(self, batch_dict):
        ...
        roi_grid_coords = torch.cat([roi_grid_coords_x, roi_grid_coords_y, roi_grid_coords_z], dim=-1) #### 妈的 
    ...
    def forward(self, batch_dict):
        ...
        if not self.training:
            ...
            targets_dict['pseudo_reg'] = rcnn_reg
            targets_dict['pseudo_cls'] = rcnn_cls
