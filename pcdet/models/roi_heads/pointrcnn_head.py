...
class PointRCNNHead(RoIHeadTemplate):
    ...
    def roipool3d_gpu(self, batch_dict):
        ...
        with torch.no_grad():
            ...
            pooled_features = pooled_features.view(-1, pooled_features.shape[2],pooled_features.shape[3] )
    ...
    def forward(self, batch_dict):
        ...
        # print(l_xyz[0].shape , l_features[0].shape )
        point_features = point_coords[:,1:] 
        ...
        pooled_points, pooled_lidar_features = self.roi_grid_pool_layer(
            xyz=xyz.contiguous(),
